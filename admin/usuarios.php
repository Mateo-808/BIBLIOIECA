                ...
                <table style="width: 100%; border-collapse: collapse; font-family: Arial, sans-serif; text-align: left;">
                    <thead>
                        <tr style="background-color: #007bff; color: white;">
                            ...
                            <th style="padding: 12px; border: 1px solid #ddd;">Dirección</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="padding: 10px; border: 1px solid #ddd;">maria@example.com</td>
                            <td style="padding: 10px; border: 1px solid #ddd;">3124567890</td>
                            <td style="padding: 10px; border: 1px solid #ddd;">Calle 10 #5-30</td>
                            <td style="padding: 10px; border: 1px solid #ddd;">2025-10-10</td>
                            <td style="padding: 10px; border: 1px solid #ddd; text-align: center;">
                                <a href="#"
                                style="background-color: #ffc107; color: white; text-decoration: none; padding: 6px 12px; border-radius: 4px; margin-right: 5px; display: inline-block;">
                                Editar
                                </a>
